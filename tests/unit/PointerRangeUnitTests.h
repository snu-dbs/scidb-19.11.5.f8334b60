...
class PointerRangeTests : public CppUnit::TestFixture
{
 ...
 private:
    static  std::string            asString(cchars,char);
    static  std::string            m( chars r)           {return asString(r,'m');}
    static  std::string            c(cchars r)           {return asString(r,'c');}
    static  std::string            s( chars r)           {return asString(r,'m');}
    static  std::string            s(cchars r)           {return asString(r,'c');}
 ...
 */
std::string PointerRangeTests::asString(cchars r,char c)
{
    std::ostringstream o;
    o << c << '(';
    insertRange(o,r);
...
void PointerRangeTests::conversions()
{
    ...
    char          const ca[] = {'c','a'};
    std::string              ms   = "ms";
    std::string        const cs   = "cs";
    std::vector<char>        mv   = {'m', 'v'};
    std::vector<char>  const cv   = {'c', 'v'};
